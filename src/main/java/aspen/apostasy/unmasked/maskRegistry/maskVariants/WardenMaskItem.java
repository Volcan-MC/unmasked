...
public class WardenMaskItem extends TrinketItem implements TrinketRenderer {

    private static final Identifier TEXTURE = Identifier.of(Unmasked.MOD_ID, "textures/entity/trinket/warden.png");
    private BipedEntityModel<BipedEntityRenderState> model;

    public WardenMaskItem(Settings settings) {
        super(settings);
    }
