...
public class PaperMaskItem extends TrinketItem implements TrinketRenderer {

    private static final Identifier TEXTURE = Identifier.of(Unmasked.MOD_ID, "textures/entity/trinket/paper.png");
    private BipedEntityModel<BipedEntityRenderState> model;

    public PaperMaskItem(Settings settings) {
        super(settings);
    }
